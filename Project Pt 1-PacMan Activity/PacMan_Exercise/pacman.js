...
function Run() {
  ...
  focus = (focus + 1) % 2;
  direction = checkPageBounds(direction, imgWidth, pos, pageWidth); //will return true or false
  //imgWidth = 350, direction = 0, pos = 0, pageWidth = 350, 
  img.src = pacArray[direction][focus];
  if (direction==1) {
    pos -= 20; //moves 20 forward 
    img.style.left = pos + 'px';
  } else {
    pos += 20; //moves 20 backward
    img.style.left = pos + 'px';
  }
}
